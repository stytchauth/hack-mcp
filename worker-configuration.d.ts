// Generated by Wrangler by running `wrangler types` (hash: d9c0029c2953f6d8f22f58864d1fc182)
// Runtime types generated with workerd@1.20250321.0 2025-03-19 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		API_KEYS: KVNamespace;
		MEMBER_API_KEYS: KVNamespace;
		STYTCH_PROJECT_ID: string;
		STYTCH_PROJECT_SECRET: string;
		ENCRYPTION_KEY: string;
		MCP_OBJECT: DurableObjectNamespace<import("./api/index").WeatherAppMCP>;
		ASSETS: Fetcher;
	}
}
